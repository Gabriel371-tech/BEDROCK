      ...
      <div className="w-full max-w-4xl flex flex-col md:flex-row bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="w-full md:w-1/2 bg-bedrock-primary p-8 text-white flex flex-col justify-center">
          ...
          <p className="text-blue-100 mb-6">
            The all-in-one platform for students and teachers to manage courses, tasks, grades, and communication.
          </p>
          <div className="mt-4 space-y-3">
            <div className="flex items-center">
              ...
              <p className="text-sm">Organize your academic life in one place</p>
            </div>
            <div className="flex items-center">
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
              ...
              <p className="text-sm">Track your assignments and grades</p>
            </div>
            <div className="flex items-center">
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
              ...
              <p className="text-sm">Communicate effortlessly with professors and classmates</p>
            </div>
          </div>
        </div>
